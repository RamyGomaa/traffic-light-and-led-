...
void DIO_SetPinDirection(u8 PortIdCopy,u8 PinIdCopy,u8 PinDirCopy){
	if ((PortIdCopy <= PORTD) && (PinIdCopy <=PIN7))
	{
		...
		{
			switch (PortIdCopy){
				case PORTA:SET_BIT(DDRA_Register,PinDirCopy);break;
				case PORTB:SET_BIT(DDRB_Register,PinDirCopy);break;
				case PORTC:SET_BIT(DDRC_Register,PinDirCopy);break;
				case PORTD:SET_BIT(DDRD_Register,PinDirCopy);break;
			}
			...
			switch (PortIdCopy){
				case PORTA:CLR_BIT(DDRA_Register,PinDirCopy);break;
				case PORTB:CLR_BIT(DDRB_Register,PinDirCopy);break;
				case PORTC:CLR_BIT(DDRC_Register,PinDirCopy);break;
				case PORTD:CLR_BIT(DDRD_Register,PinDirCopy);break;
			}
			}else{
			//nothing
		}
